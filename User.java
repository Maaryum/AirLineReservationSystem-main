...
public class User {
    ...
    public static void main(String[] args) {
        ...
        int countNumOfUsers = 1; // keeps track of the number of registered users
        RolesAndPermissions r1 = new RolesAndPermissions();
        Flight f1 = new Flight(); //method for flight class
        FlightReservation bookingAndReserving = new FlightReservation();
        Customer c1 = new Customer();
        f1.flightScheduler();
        Scanner read = new Scanner(System.in); //Scanner object named read to read input from the console.

// welcomeScreen method with the argument 1
        welcomeScreen(1);
       // Outputs welcome messages and calls the displayMainMenu method.
        ...
        //Validates user input, ensuring it is between 0 and 8.
        while (desiredOption < 0 || desiredOption > 8) {
            System.out.print("ERROR!! Please enter value between 0 - 4. Enter the value again :\t");
            desiredOption = read.nextInt(); //Reads an integer input from the user.
        }
        ...
        do {
            ...
            if (desiredOption == 1) {
                ...
                if (Integer.parseInt(result[0]) == 1) {
                    ...
                    // handles the passenger's menu after successful login.
                    int desiredChoice;
    ...
    static void welcomeScreen(int option) {
        ...
        if (option == 1) {
            artWork = """
                    ...
                    888       888          888                                                888                  888P           P888          d8888   888    88              d8888 d8b         888 d8b                           \s
                    888   o   888          888                                                888                  8888P         P8888         d88888   888   88Y             d88888 Y8P         888 Y8P                           \s
                    888  d8b  888          888                                                888                  88888P       P88888        d88P888   888  88Y             d88P888             888                               \s
                    888 d888b 888  .d88b.  888  .d8888b  .d88b.  88888b.d88b.   .d88b.        888888  .d88b.       888P88P88888P888888       d88P 888   888o88Y             d88P 888 888 888d888 888 888 88888b.   .d88b.  .d8888b \s
                    888d88888b888 d8P  Y8b 888 d88P"    d88""88b 888 "888 "88b d8P  Y8b       888    d88""88b      888   8P8P8P    888      d88P  888   88888o             d88P  888 888 888P"   888 888 888 "88b d8P  Y8b 88K     \s
                    88888P Y88888 88888888 888 888      888  888 888  888  888 88888888       888    888  888      888     P8P     888     d88P   888   888 88Y           d88P   888 888 888     888 888 888  888 88888888 "Y8888b.\s
                    8888P   Y8888 Y8b.     888 Y88b.    Y88..88P 888  888  888 Y8b.           Y88b.  Y88..88P      888      o      888    d8888888888   888   88Y        d8888888888 888 888     888 888 888  888 Y8b.          X88\s
                    888P     Y888  "Y8888  888  "Y8888P  "Y88P"  888  888  888  "Y8888         "Y888  "Y88P"       888             888   d88P     888   888    88Y      d88P     888 888 888     888 888 888  888  "Y8888   88888P'\s
                                                                                                                                                                                                                         \s
                                                                                                                                                                                                                         \s
                                                                                                                                                                                                                         \s
                    """;
